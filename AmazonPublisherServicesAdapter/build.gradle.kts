...
=======
    implementation("com.amazon.android:aps-sdk:9.9.5")
>>>>>>> 2a20fa0 ([HB-7689] Version pumps for Mediation 5 (#70))
=======
    implementation("com.amazon.android:aps-sdk:9.10.1")
    implementation("com.iabtcf:iabtcf-decoder:2.0.10")
>>>>>>> 608b8ef ([HB-7689] Catching up with latest certified versions (#78))
