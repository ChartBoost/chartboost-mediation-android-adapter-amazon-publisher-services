...
android {
    namespace = "com.chartboost.helium.amazonpublisherservicesadapter"
    compileSdk = 33
    ...
    defaultConfig {
        ...
        buildConfigField("String", "HELIUM_APS_ADAPTER_VERSION", "\"${android.defaultConfig.versionName}\"")
...
artifactory {
    ...
    publish {
        ...
        defaults {
            publications("AmazonPublisherServicesAdapter", "aar")
    ...
    publishing {
        publications {
            register<MavenPublication>("remoteRelease") {
                ...
                var adapterName = "amazon-publisher-services"
                ...
                pom {
                    name.set("Helium Adapter Amazon Publisher Services")
