...
curl -sSf -u "$JFROG_USER:$JFROG_PASS" -O 'https://cboost.jfrog.io/artifactory/private-helium/com/chartboost/helium-adapter-amazon-publisher-services/maven-metadata.xml'
